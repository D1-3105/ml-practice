...
from src.schema.user_schema import FindUser, User
...
class AuthService(BaseService):
    ...
    def sign_in(self, sign_in_info: SignIn):
        ...
        user = self.user_repository.read_by_options(find_user)["founds"]
        if len(user) < 1:
    ...
    def sign_up(self, user_info: SignUp, is_superuser=False):
